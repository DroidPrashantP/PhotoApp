...
import com.app.camera.collagelib.MyAdapter;
...
public class SquareColorPickerAdapter extends MyRecylceAdapterBase<SquareColorPickerAdapter.ViewHolder> implements View.OnClickListener {
    ...
    int colorSelected;
    String[] colors;
    SquareActivity.C09595 listener;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private int item;
        SquareActivity.C09595 viewHolderListener;

        public void setCurrentCollageIndexChangedListener(SquareActivity.C09595 l) {
    ...
    public SquareColorPickerAdapter(SquareActivity.C09595 l, int cDefault, int cSelected) {
        this.colorCount = 60;
